...
| Notizen | 🟡 | Eigener Hauptbereich in der Sidebar. Er öffnet direkt die zentrale Notizerfassung: allgemeine Klassen-Notiz oder Kind auswählen, Kategorie wählen (Notiz, Beobachtung/Verhalten, Erfolg/Stärke, Elternkontakt, Klassenjournal), Text eingeben und speichern. Chronik, Suche und Filter bleiben klassenlokal; Beobachtungsstatus ist nur noch ein sekundärer Tab. Stimm-Notizen bleiben separat. Reale Browser-Abnahme offen. |
