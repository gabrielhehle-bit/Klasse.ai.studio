...
export const DEFAULT_MORNING_WIDGETS: MorningWidget[] = [
  ...
  { id: 'l4', type: 'logik', stufe: 'all', frage: 'Ich bin größer als 20 und kleiner als 30. Meine beiden Ziffern ergeben zusammen 9. Welche Zahl bin ich?', loesung: '27' },
  { id: 'l5', type: 'logik', stufe: 'all', frage: 'Was hat 4 Beine und kann nicht laufen?', loesung: 'Ein Tisch / Ein Stuhl' },
  { id: 'l6', type: 'logik', stufe: 'all', frage: 'Ein Bauer hat 17 Schafe. Alle bis auf 9 laufen weg. Wie viele Schafe bleiben?', loesung: '9' },
