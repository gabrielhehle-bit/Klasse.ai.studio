  ...
  const addClass = React.useCallback((name: string, stufe: number, isKV: boolean) => {
    ...
    setApp(prev => {
      ...
      return {
        ...
        scheduleAnalysis: newClass.scheduleAnalysis || {},
        savedWeekTemplates: newClass.savedWeekTemplates || {},
        parkgarage: newClass.parkgarage || [],
        termine: newClass.termine || [],
    ...
    setAppInternal(prev => {
      ...
      if (remainingClasses.length > 0) {
        ...
        return {
          ...
          scheduleAnalysis: nextClass.scheduleAnalysis ? JSON.parse(JSON.stringify(nextClass.scheduleAnalysis)) : {},
          savedWeekTemplates: nextClass.savedWeekTemplates ? JSON.parse(JSON.stringify(nextClass.savedWeekTemplates)) : {},
          parkgarage: nextClass.parkgarage ? JSON.parse(JSON.stringify(nextClass.parkgarage)) : [],
          termine: nextClass.termine ? JSON.parse(JSON.stringify(nextClass.termine)) : [],
