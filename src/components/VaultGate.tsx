...
export default function VaultGate({ children }: VaultGateProps) {
  ...
  if (gateState === 'checking') {
    return (
      <div className="min-h-screen w-full bg-[var(--surface-bg,var(--surface))] flex flex-col items-center justify-center gap-4 text-[var(--text-main)]">
        <div className="w-10 h-10 border-4 border-[var(--accent)] border-t-transparent rounded-full animate-spin" />
        <div className="text-[var(--text-sub)] font-mono text-xs uppercase tracking-widest font-semibold">
          Prüfe Datentresor...
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen w-full bg-[var(--surface-bg,var(--surface))] flex items-center justify-center p-4">
      <motion.div
        ...
        className="w-full max-w-md bg-[var(--surface-card,var(--surface))] border border-[var(--border,var(--border-subtle))] backdrop-blur-xl rounded-2xl shadow-2xl p-6 md:p-8 text-[var(--text-main)]"
      >
        {/* Header-Bereich */}
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <p className="text-xs text-[var(--text-sub)] mt-1 max-w-xs leading-relaxed">
        ...
        {gateState === 'needs_setup' && setupStep === 'password' && (
          <form onSubmit={handleGenerateVault} className="space-y-4">
            {hasLegacyData && (
              <div className="p-3 bg-[var(--accent-soft)] border border-[var(--accent)]/25 rounded-xl flex items-start gap-2.5 text-[var(--text-main)] text-xs">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full bg-[var(--surface-subtle,var(--surface))] border border-[var(--border)] rounded-xl px-3.5 py-2.5 text-sm text-[var(--text-main)] placeholder-[var(--text-muted)] focus:outline-none focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)]"
                />
                <button
                  type="button"
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <button
                ...
                className="mt-2 w-full py-1.5 px-3 bg-[var(--surface-muted)] hover:bg-[var(--surface-subtle)] text-[var(--text-main)] border border-[var(--border)] rounded-lg text-xs font-medium flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
              >
            ...
            <div className="pt-2">
              <label className="flex items-start gap-2.5 cursor-pointer text-xs text-[var(--text-sub)] select-none">
                <input
                  type="checkbox"
            ...
            <div className="pt-2 flex gap-2">
              <button
                ...
                className="w-1/3 py-2.5 px-3 bg-[var(--surface-muted)] hover:bg-[var(--surface-subtle)] text-[var(--text-main)] border border-[var(--border)] rounded-xl text-xs font-medium transition-colors cursor-pointer"
              >
                Zurück
              </button>
              <button
          ...
          <form onSubmit={handleUnlockWithRecoveryCode} className="space-y-4">
            <div>
              ...
              <input
                ...
                autoFocus
                required
                className="w-full bg-[var(--surface-subtle,var(--surface))] border border-[var(--border)] rounded-xl px-3.5 py-2.5 text-sm font-mono text-[var(--text-main)] placeholder-[var(--text-muted)] focus:outline-none focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)]"
              />
            </div>
