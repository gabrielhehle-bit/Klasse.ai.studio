      ...
      >
        ...
        <div className="relative z-10 space-y-8 text-center sm:text-left">
          ...
          <div className="space-y-3">
            ...
            <p className="text-[var(--text-muted)] font-medium text-[1.125rem] leading-relaxed max-w-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-[0.75rem] leading-tight text-[var(--success-text)]/80 font-medium">Minimalistisch: Nur Dashboard, Schüler, Noten, Anwesenheit und der KI-Helfer. Keine Ablenkung.</p>
            </button>
            ...
            >
              ...
              <p className="text-[0.75rem] leading-tight text-[var(--text-muted)] font-medium">Voller Umfang: Diagnostik, Statistiken, Archiv, Kasse und sämtliche Checklisten sind sofort sichtbar.</p>
            </button>
