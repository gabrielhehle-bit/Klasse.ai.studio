...
## Hauptnavigation: weniger Entscheidungen (11. September)

Sechs Standard-Einstiege: Mein Schultag, Unterricht starten, Wochenplan, Kinder & Dossiers, Anwesenheit und Notenmappe. Weitere zugelassene Bereiche erscheinen gesammelt über „Weitere Funktionen“. Eine bereits geöffnete zusätzliche Seite bleibt auch bei eingeklappter Auswahl sichtbar. Backup & Daten sowie Einstellungen bleiben unabhängig von Ausblendungen direkt erreichbar, damit der Zugang zu Sicherung und Konfiguration nicht verloren geht.

Die vorhandenen Rollenfilter und persönlichen Ausblendungen der Fachmodule bleiben bestehen. Seiten-IDs und Routing ändern sich nicht. Die zusammengeführte Modulliste verhindert abweichende Bezeichnungen zwischen Navigation und Anpassungsdialog. Veraltete Gruppennamen im bisherigen Anpassungsdialog hatten Klasse/Kinder und Entwicklung/Berichte dort verschwinden lassen; die Gruppen werden jetzt aus derselben Liste abgeleitet. Die verwirrenden Fokus-/Standard-/Experten-Presets werden in diesem Dialog durch einzelne Auswahlen und „Alle Bereiche einblenden“ ersetzt. Bereits gespeicherte Preset-Ausblendungen werden nicht zurückgesetzt.

660 automatisierte Tests bestanden; darunter zwei neue Tests zu Alltagsreihenfolge, vollständiger Zuordnung, eigenen Ausblendungen und erreichbaren Systemseiten. Nach der abschließenden Absicherung der Systemseiten wurden diese beiden Tests nochmals erfolgreich ausgeführt. TypeScript und Produktionsbuild erfolgreich; praktische responsive/visuelle Prüfung weiterhin offen. Dies vereinfacht die Navigation, ersetzt noch nicht die Überarbeitung der einzelnen Fachseiten, Formulare und Dialoge.

## Korrekturen für Anwesenheit und Bewertungsabschnitte

- Der Besuch der Anwesenheitsseite trägt nicht mehr automatisch Anwesenheiten ein. Leere Stunden zeigen einen neutralen Strich; unvollständige Tage werden im Ausdruck als nicht vollständig erfasst bezeichnet.
- „Offene Einträge als anwesend bestätigen“ ergänzt nur leere Stunden. Bestehende entschuldigte/unentschuldigte Abwesenheiten, andere Statuswerte, andere Tage und nicht ausgewählte Kinder bleiben erhalten. Der bestehende Rückgängig-Pfad wird auch dafür genutzt. Teilweise erfasste Stunden zählen als offen; ohne geplante Stunden ist Abschließen deaktiviert.
- Die ausdrücklich gewählte Aktion „Alle anwesend“ bleibt eine Gesamtänderung und kann vorhandene Tagesstatus ersetzen. Diese Aktion ist vom Ergänzen fehlender Einträge getrennt.
- Namen, Datum, Höchstpunkte sowie Hinzufügen/Entfernen von Bewertungsspalten betreffen ausschließlich das gewählte Fach. Die alte Metadatenkopplung über syncWpDeutschMath wird dabei ignoriert. Bereits gespeicherte Daten werden nicht migriert oder rückwirkend geändert.
